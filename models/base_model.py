...
class BaseModel():
    ...
    def save(self):
        """
        Case strategy to:
        - Update the current date and time; - Call the save() function; - Save to a serialized file
        """
        self.updated_at = datetime.now()
        models.storage.save()
    ...
    def to_dict(self):
        """
        Return word reference of BaseModel with string organizations of times
        """
